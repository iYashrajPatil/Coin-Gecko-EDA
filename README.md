...
The dataset consists of **18,000+ records** covering pricing, market capitalization, volume, and short-term performance metrics.
...
- Difficult to analyze due to frequent price fluctuations  

Investors and analysts often struggle to extract **clear trends and actionable insights** from noisy market data.
...
- Analyze **price trends and anomalies**
- Compare **market capitalization vs trading volume** to assess liquidity
- Study dominance of major cryptocurrencies (BTC, ETH, Stablecoins)
- Analyze **volatility & correlations** to understand risk and diversification
...
│ └── coingecko_cleaned.csv
│
├── notebooks/
│ ├── CoinGecko_webscrapping.ipynb
│ └── CoinGecko_EDA.ipynb
│
├── presentation/
│ └── EDA.pptx
...
- Smaller coins show higher volatility and short-term risk
...
i. CoinGecko_webscrapping.ipynb
